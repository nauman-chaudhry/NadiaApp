-- Migration 011: Filter joined_stats_hourly MV to Taboola source for Codefuel
-- This ensures Outbrain-sourced Codefuel revenue is excluded from Taboola dashboard,
-- deferring it to the Outbrain milestone.
